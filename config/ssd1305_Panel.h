/*
 * ssd1305_Panel.h - User specific configuration for Arduino GLCD library
 *
 * Use this file to set LCD panel parameters
 * This version is for a ssd1305 display
 ...
 */
#define glcd_PanelConfigName "ssd1305"
 ...
 * XXX Dummy value - ssd1305 only has one chip
 */
#define glcd_CHIP_COUNT 2 //((DISPLAY_WIDTH + CHIP_WIDTH - 1)  / CHIP_WIDTH) 
 ...
 */
#else
#error "The number of Chips and Chip Select pins does not match an option in ssd1305_Panel.h"
...
#include "config/ssd1305_Mega.h"      // config for mega 1280/2560 board
#elif defined(__AVR_ATmega644P__)  || defined(__AVR_ATmega644__)           
#error There is no configuration for sanguino yet
#include "config/ssd1305_Sanguino.h"  // config for Sanguino or other ATmega644/p board
#elif defined(__AVR_AT90USB646__) || defined(__AVR_AT90USB1286__) || defined(__AVR_ATmega32U4__)// Teensy
#error There is no configuration for teensy yet
#include "config/ssd1305_Teensy.h"    // config for Teensy and Teensy++  
#else
#error There is no configuration for arduino yet
#include "config/ssd1305_Arduino.h"   // config file for standard Arduino using documented wiring 
#endif

#include "device/ssd1305_Device.h"
