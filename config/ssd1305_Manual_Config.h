/*
 * XXX XXX XXX this is afaik unused. Should be invoked from ../glcd_Config.h
 *             only if the automatic file (ssd1305_Mega.h) is NOT invoked.
 *
 * ssd1305_Manual_Config.h - User specific configuration for Arduino GLCD library
 *
 * Use this file to set io pins and LCD panel parameters
 * This version is for a standard ssd1305 display
 ...
 */
#define glcd_PanelConfigName "ssd1305-Manual"

/*********************************************************/
/*  Configuration for LCD panel specific configuration   */
/*********************************************************/
#define DISPLAY_WIDTH 128  // XXX is this 132 in reality?
#define DISPLAY_HEIGHT 64

// panel controller chips
#define CHIP_WIDTH     64  // pixels per chip // XXX is this 66 in reality?
 ...
 */
#define glcd_PinConfigName "ssd1305-Manual"
