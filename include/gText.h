...
class gText : public glcd_Device
{
  ...
  public:
	Font_t			Font; // moved from private by gammy
	uint8_t			FontColor;
...
/*@{*/
	...
	// Desperate way to read font data: ANY other way immediately reboots the board //gammy
	uint8_t EmergencyFontRead(uint16_t data);
